...
use crate::types::actions::v1::*;
use crate::types::keys::v1::*;

// use crate::types::keys::AddressIndex;
// use crate::types::view::v1::NotesRequest;
// use crate::action::{TransactionParameters, TransactionPlan};
...
//             transaction_parameters: Some(TransactionParameters {
