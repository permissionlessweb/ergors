...
pub struct Fee {
    ...
    pub asset_id: ::core::option::Option<super::super::asset::v1::AssetId>,
}
impl ::prost::Name for Fee {
    const NAME: &'static str = "Fee";
    const PACKAGE: &'static str = "ergors.fee.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.fee.v1.Fee".into()
    }
...
impl ::prost::Name for FeeParameters {
    ...
    const PACKAGE: &'static str = "ergors.fee.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.fee.v1.FeeParameters".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.fee.v1.FeeParameters".into()
    }
...
impl ::prost::Name for GenesisContent {
    ...
    const PACKAGE: &'static str = "ergors.fee.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.fee.v1.GenesisContent".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.fee.v1.GenesisContent".into()
    }
...
impl ::prost::Name for CurrentGasPricesRequest {
    ...
    const PACKAGE: &'static str = "ergors.fee.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.fee.v1.CurrentGasPricesRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.fee.v1.CurrentGasPricesRequest".into()
    }
...
impl ::prost::Name for CurrentGasPricesResponse {
    ...
    const PACKAGE: &'static str = "ergors.fee.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.fee.v1.CurrentGasPricesResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.fee.v1.CurrentGasPricesResponse".into()
    }
...
impl ::prost::Name for EventPaidFee {
    ...
    const PACKAGE: &'static str = "ergors.fee.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.fee.v1.EventPaidFee".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.fee.v1.EventPaidFee".into()
    }
...
impl ::prost::Name for EventBlockFees {
    ...
    const PACKAGE: &'static str = "ergors.fee.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.fee.v1.EventBlockFees".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.fee.v1.EventBlockFees".into()
    }
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/ergors.fee.v1.QueryService/CurrentGasPrices",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ergors.fee.v1.QueryService", "CurrentGasPrices"),
                );
...
pub mod query_service_server {
    ...
    pub const SERVICE_NAME: &str = "ergors.fee.v1.QueryService";
