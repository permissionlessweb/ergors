...
pub struct EncryptedApiKeyStore {
    /// Version for migration support
    #[prost(uint32, tag = "1")]
    pub version: u32,
    /// All encrypted provider API keys
    #[prost(message, repeated, tag = "2")]
    pub keys: ::prost::alloc::vec::Vec<EncryptedApiKey>,
    /// Metadata
    #[prost(message, optional, tag = "3")]
...
impl ::prost::Name for EncryptedApiKeyStore {
    const NAME: &'static str = "EncryptedApiKeyStore";
    const PACKAGE: &'static str = "ergors.storage.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.storage.v1.EncryptedApiKeyStore".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.storage.v1.EncryptedApiKeyStore".into()
    }
