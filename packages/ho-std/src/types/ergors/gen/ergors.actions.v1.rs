...
impl ::prost::Name for PromptPlan {
    const NAME: &'static str = "PromptPlan";
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.PromptPlan".into()
    }
...
pub struct Transaction {
    ...
    pub binding_sig: ::core::option::Option<
        super::super::decaf377_rdsa::v1::BindingSignature,
    >,
...
impl ::prost::Name for Transaction {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.Transaction".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.Transaction".into()
    }
...
impl ::prost::Name for TransactionBody {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.TransactionBody".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.TransactionBody".into()
    }
...
impl ::prost::Name for TransactionParameters {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.TransactionParameters".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.TransactionParameters".into()
    }
...
impl ::prost::Name for TransactionSummary {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.TransactionSummary".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.TransactionSummary".into()
    }
...
pub struct DetectionData {
    ...
    pub fmd_clues: ::prost::alloc::vec::Vec<super::super::decaf377_fmd::v1::Clue>,
}
impl ::prost::Name for DetectionData {
    const NAME: &'static str = "DetectionData";
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.DetectionData".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.DetectionData".into()
    }
...
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct Action {
    #[prost(oneof = "action::Action", tags = "1")]
...
pub mod action {
    ...
    pub enum Action {
        #[prost(message, tag = "1")]
        Prompt(super::super::super::orch::v1::PromptRequest),
    }
}
...
pub mod transaction_perspective {
    ...
    impl ::prost::Name for ExtendedMetadataById {
        ...
        const PACKAGE: &'static str = "ergors.actions.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "ergors.actions.v1.TransactionPerspective.ExtendedMetadataById".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/ergors.actions.v1.TransactionPerspective.ExtendedMetadataById".into()
        }
    ...
    pub struct CreationTransactionIdByNullifier {
        #[prost(message, optional, tag = "1")]
        pub nullifier: ::core::option::Option<super::super::super::sct::v1::Nullifier>,
        #[prost(message, optional, tag = "2")]
    ...
    impl ::prost::Name for CreationTransactionIdByNullifier {
        ...
        const PACKAGE: &'static str = "ergors.actions.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "ergors.actions.v1.TransactionPerspective.CreationTransactionIdByNullifier"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/ergors.actions.v1.TransactionPerspective.CreationTransactionIdByNullifier"
    ...
    pub struct NullificationTransactionIdByCommitment {
        ...
        pub commitment: ::core::option::Option<
            super::super::super::tct::v1::StateCommitment,
        >,
        #[prost(message, optional, tag = "2")]
        pub transaction_id: ::core::option::Option<
            super::super::super::txhash::v1::TransactionId,
    ...
    impl ::prost::Name for NullificationTransactionIdByCommitment {
        ...
        const PACKAGE: &'static str = "ergors.actions.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "ergors.actions.v1.TransactionPerspective.NullificationTransactionIdByCommitment"
                .into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/ergors.actions.v1.TransactionPerspective.NullificationTransactionIdByCommitment"
...
impl ::prost::Name for TransactionPerspective {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.TransactionPerspective".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.TransactionPerspective".into()
    }
...
impl ::prost::Name for PayloadKeyWithCommitment {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.PayloadKeyWithCommitment".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.PayloadKeyWithCommitment".into()
    }
...
impl ::prost::Name for NullifierWithNote {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.NullifierWithNote".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.NullifierWithNote".into()
    }
...
impl ::prost::Name for TransactionView {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.TransactionView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.TransactionView".into()
    }
...
impl ::prost::Name for TransactionBodyView {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.TransactionBodyView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.TransactionBodyView".into()
    }
...
pub struct ActionView {
    #[prost(oneof = "action_view::ActionView", tags = "1")]
...
impl ::prost::Name for ActionView {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.ActionView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.ActionView".into()
    }
...
pub struct AuthorizationData {
    ...
    pub spend_auths: ::prost::alloc::vec::Vec<
        super::super::decaf377_rdsa::v1::SpendAuthSignature,
    >,
...
impl ::prost::Name for AuthorizationData {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.AuthorizationData".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.AuthorizationData".into()
    }
...
impl ::prost::Name for WitnessData {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.WitnessData".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.WitnessData".into()
    }
...
impl ::prost::Name for TransactionPlan {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.TransactionPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.TransactionPlan".into()
    }
...
impl ::prost::Name for CluePlan {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.CluePlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.CluePlan".into()
    }
...
impl ::prost::Name for DetectionDataPlan {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.DetectionDataPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.DetectionDataPlan".into()
    }
...
pub struct ActionPlan {
    #[prost(oneof = "action_plan::Action", tags = "1")]
...
impl ::prost::Name for ActionPlan {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.ActionPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.ActionPlan".into()
    }
...
impl ::prost::Name for MemoPlan {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.MemoPlan".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.MemoPlan".into()
    }
...
impl ::prost::Name for MemoCiphertext {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.MemoCiphertext".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.MemoCiphertext".into()
    }
...
pub struct MemoPlaintext {
    ...
    #[prost(string, tag = "1")]
    pub return_address: ::prost::alloc::string::String,
...
impl ::prost::Name for MemoPlaintext {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.MemoPlaintext".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.MemoPlaintext".into()
    }
...
impl ::prost::Name for MemoPlaintextView {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.MemoPlaintextView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.MemoPlaintextView".into()
    }
...
pub mod memo_view {
    ...
    impl ::prost::Name for Visible {
        ...
        const PACKAGE: &'static str = "ergors.actions.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "ergors.actions.v1.MemoView.Visible".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/ergors.actions.v1.MemoView.Visible".into()
        }
    ...
    impl ::prost::Name for Opaque {
        ...
        const PACKAGE: &'static str = "ergors.actions.v1";
        fn full_name() -> ::prost::alloc::string::String {
            "ergors.actions.v1.MemoView.Opaque".into()
        }
        fn type_url() -> ::prost::alloc::string::String {
            "/ergors.actions.v1.MemoView.Opaque".into()
        }
...
impl ::prost::Name for MemoView {
    ...
    const PACKAGE: &'static str = "ergors.actions.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "ergors.actions.v1.MemoView".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/ergors.actions.v1.MemoView".into()
    }
