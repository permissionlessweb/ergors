...
impl ::prost::Name for MsgStoreCodeWithVk {
    const NAME: &'static str = "MsgStoreCodeWithVk";
    const PACKAGE: &'static str = "cosmwasm.wasm.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "cosmwasm.wasm.v1.MsgStoreCodeWithVk".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/cosmwasm.wasm.v1.MsgStoreCodeWithVk".into()
    }
...
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, Eq, Hash, ::prost::Message)]
pub struct MsgStoreCodeWithVkResponse {
    /// CodeID is the reference to the stored WASM code
    #[prost(uint64, tag = "1")]
    pub code_id: u64,
...
impl ::prost::Name for MsgStoreCodeWithVkResponse {
    const NAME: &'static str = "MsgStoreCodeWithVkResponse";
    const PACKAGE: &'static str = "cosmwasm.wasm.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "cosmwasm.wasm.v1.MsgStoreCodeWithVkResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/cosmwasm.wasm.v1.MsgStoreCodeWithVkResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn store_code_with_vk(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgStoreCodeWithVk>,
        ) -> std::result::Result<
            tonic::Response<super::MsgStoreCodeWithVkResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/cosmwasm.wasm.v1.Msg/StoreCodeWithVk",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("cosmwasm.wasm.v1.Msg", "StoreCodeWithVk"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod msg_server {
    ...
    pub trait Msg: std::marker::Send + std::marker::Sync + 'static {
        ...
        >;
        /// StoreCode to submit Wasm code to the system, along with an Halo2 Verifying Key
        async fn store_code_with_vk(
            &self,
            request: tonic::Request<super::MsgStoreCodeWithVk>,
        ) -> std::result::Result<
            tonic::Response<super::MsgStoreCodeWithVkResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/cosmwasm.wasm.v1.Msg/StoreCodeWithVk" => {
                    #[allow(non_camel_case_types)]
                    struct StoreCodeWithVkSvc<T: Msg>(pub Arc<T>);
                    impl<T: Msg> tonic::server::UnaryService<super::MsgStoreCodeWithVk>
                    for StoreCodeWithVkSvc<T> {
                        type Response = super::MsgStoreCodeWithVkResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Msg>::store_code_with_vk(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = StoreCodeWithVkSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
