...
pub mod custody_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn authorize(
            ...
            let path =
                http::uri::PathAndQuery::from_static("/ergors.custody.v1.CustodyService/Authorize");
        ...
        ) -> std::result::Result<tonic::Response<super::ExportFullViewingKeyResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        ) -> std::result::Result<tonic::Response<super::DecryptApiKeyResponse>, tonic::Status>
        {
            self.inner.ready().await.map_err(|e| {
                tonic::Status::unknown(format!("Service was not ready: {}", e.into()))
            })?;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/ergors.custody.v1.CustodyService/Authorize" => {
                    ...
                    impl<T: CustodyService> tonic::server::UnaryService<super::AuthorizeRequest> for AuthorizeSvc<T> {
                ...
                "/ergors.custody.v1.CustodyService/ExportFullViewingKey" => {
                        ...
                        for ExportFullViewingKeySvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustodyService>::export_full_viewing_key(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/ergors.custody.v1.CustodyService/DecryptApiKey" => {
                    ...
                    impl<T: CustodyService> tonic::server::UnaryService<super::DecryptApiKeyRequest>
                        for DecryptApiKeySvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as CustodyService>::decrypt_api_key(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
