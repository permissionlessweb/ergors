...
pub mod query_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("ergors.sct.v1.QueryService", "AnchorByHeight"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("ergors.sct.v1.QueryService", "EpochByHeight"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("ergors.sct.v1.QueryService", "TimestampByHeight"),
                );
            self.inner.unary(req, path, codec).await
        }
