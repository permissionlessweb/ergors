...
## TASK 1: Implement ssh boostrap framework

- derive 1-time unique key for ssh with node sk
...
## Self Improve Step: summarize/log results to storage

## TASK 2: Utilliize Tree more robustly
...
## TASK 3: Improve Archetecture of Session classification
...
## TASK 4: Improve UX for NODE CLI: (print info about node in metadata, display url for gui & api commands)
