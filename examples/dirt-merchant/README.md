...
GOALS: make prompts to use this crate to generate a prompt that is for defining an agent workflow for walking throught with a user to create a demo for any product given the context and the repo.
...
## Requirements
    ...
    - context definition creation step: 
        ...
        - Reasearch Script/Pre Prompt-for-prompt generation to occur
    - human feedback step 

    ## Core Development Sandloops:
    - 
